...
/**
 * Configure engine settings for the viewer.
 *
...
export function setupSettings(cesdk: CreativeEditorSDK): void {
  ...
  // ============================================================================
  // EDITOR SCOPES
  // Deny all editing operations for read-only mode
  // ============================================================================

  // #region Editor Scopes
  // Prevent adding new blocks to the scene
  engine.editor.setGlobalScope('editor/add', 'Deny');

  // Prevent selecting blocks for editing
  ...
  // Double-click behavior - Enable/disable entering crop mode on double-click
  ...
  // Dim areas outside of page boundaries
  ...
  // Transform children when cropping fill to maintain relative positions
  // engine.editor.setSetting('page/moveChildrenWhenCroppingFill', false);

  // Select the page when clicking on canvas with no blocks selected
  ...
  // Remove highlight color for viewer mode (no selection allowed)
